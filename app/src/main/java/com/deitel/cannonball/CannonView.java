...
public class CannonView extends SurfaceView
    ...
    public void initSoundPool() {
        ...
        soundMap.put(TARGET_SOUND_ID, soundPool.load(getContext(), R.raw.target_hit, 1));
        soundMap.put(CANNON_SOUND_ID, soundPool.load(getContext(), R.raw.cannon_fire, 1));
        soundMap.put(BLOCKER_SOUND_ID, soundPool.load(getContext(), R.raw.blocker_hit, 1));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        screenWidth = w;
        screenHeight = h;
        cannonBaseRadius = h / 18; // 1/18th of screen height
        cannonLength = w / 8;
        ...
        backgroundPaint.setColor(Color.parseColor("#B6B6B6"));
    ...
    public void drawGameElements(Canvas canvas) {
        ...
        for (int i = 0; i < TARGET_PIECES; i++) {
            if (!hitStates[i]) {
                if (i % 2 != 0)
                    targetPaint.setColor(Color.parseColor("#F44336"));
                else
                    targetPaint.setColor(Color.parseColor("#D32F2F"));
    ...
    private void showGameOverDialog(final int messageId) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(getContext()); // getActivity()
